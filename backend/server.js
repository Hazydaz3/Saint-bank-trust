...
let transactions = [
  { id:601, icon:'trending-up', name:'Adecco Company', date:'Jun 06, 2026', dateObj: new Date('2026-06-06'), amount:'-$300,000.00', cat:'Automotive', type:'debit', merchant:'Adecco Company', ref:'AUTO-2026-601', status:'Completed', details:'Deposit from Adecco Company', createdAt: new Date(Date.now() - 7*24*60*60*1000) },
  { id:600, icon:'trending-up', name:'Adecco Company ', date:'Jun 04, 2026', dateObj: new Date('2026-06-04'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Adecco Company ', ref:'FCM-2026-600', status:'Completed', details:'Investment distribution from Adecco Capital Management', createdAt: new Date('2026-06-04') },
