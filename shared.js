...
const allTransactionsData = [
  ...
  { id:601, icon:'trending-up', name:'Adecco Company', date:'Jun 06, 2026', dateObj: new Date('2026-06-06'), amount:'-$300,000.00', cat:'Automotive', type:'debit', merchant:'Adecco Company', ref:'AUTO-2026-601', status:'Completed', details:'Deposit from Adecco Company' },
  { id:600, icon:'trending-up', name:'Adecco Company', date:'Jun 04, 2026', dateObj: new Date('2026-06-04'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Adecco Company', ref:'FCM-2026-600', status:'Completed', details:'Investment distribution from Adecco Company' },
  ...
  { id:597, icon:'trending-up', name:'Adecco Company', date:'Jun 03, 2026', dateObj: new Date('2026-06-03'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Adecco Company', ref:'FCM-2026-597', status:'Completed', details:'Investment distribution from Adecco Capital Management' },
  ...
  { id:591, icon:'trending-up', name:'Adecco Company Management', date:'Jun 01, 2026', dateObj: new Date('2026-06-01'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Founders Capital Management', ref:'FCM-2026-591', status:'Completed', details:'Investment distribution from Adecco Capital Management' },
  // 2025 transactions
  ...
  { id:590, icon:'trending-up', name:'Adecco Capital Management', date:'May 30, 2026', dateObj: new Date('2026-05-30'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Founders Capital Management', ref:'FCM-2025-590', status:'Completed', details:'Investment distribution from Adecco Capital Management' },
  ...
  { id:589, icon:'trending-up', name:'Adecco Capital Management', date:'  May 30, 2026', dateObj: new Date('2026-05-30'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Founders Capital Management', ref:'FCM-2025-589', status:'Completed', details:'Investment distribution from Adecco Capital Management' },
  ...
  { id:588, icon:'trending-up', name:'Adecco Capital Management', date:'May 29, 2026', dateObj: new Date('2026-05-29'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Founders Capital Management', ref:'FCM-2025-588', status:'Completed', details:'Investment distribution from Adecco Capital Management' },
  ...
  { id:585, icon:'trending-up', name:'Adecco Capital Management', date:'May 17, 2026', dateObj: new Date('2026-05-17'), amount:'+$150,000.00', cat:'Income', type:'credit', merchant:'Founders Capital Management', ref:'FCM-2026-585', status:'Completed', details:'Investment distribution from Adecco Capital Management' },
